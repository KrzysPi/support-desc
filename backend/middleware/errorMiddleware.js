const errorHandler = (err, req, res, next) => {
  const statusCode = res.statusCode ? res.statusCode : 500; // zwraca to co zadaliśmy  res.status(400); w userController.js jeżeli nie jest to ustawione to ccemy żeby zwrócił 500 czyli server error
